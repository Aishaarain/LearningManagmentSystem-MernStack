...
const Dashboard = () => {
  ...
  const {currency} =useState(AppContext)
...
<div>
  ...
  <div className='flex flex-col items-center max-w'>
...
<img src={item.student.imageUrl} alt="profile" className='w-9 h-7 rounded-full' />
