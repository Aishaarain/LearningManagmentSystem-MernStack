...
const [isAlreadyEnrolled, setIsAlreadyEntolled] = useState(false)
...
{...prev,
  ...
  return courseData ?  (<>
    <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
      ...
      <div className="absolute top-0 left-0 w-full h-screen-height -z-1 bg-gradient-to-b from-cyan-100/70">
      ...
      {/* left column */}
       <div className='max-w-xl z-10 text-gray-500'>
              ...
              <p className="pt-4 md:text-base text-sm" dangerouslySetInnerHTML={{__html:courseData.courseDescription.slice(0,100)}}></p>
              ...
              {/* review and rating */}
               ...
               <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
                      ...
                      <p>Course by <span className="text-blue-600 underline">TechStack</span></p>
    ...
    <div className="p-5">
      <div className="flex items-center gap-2">
       <img className="w-3.5" src={assets.time_left_clock_icon} alt="time" />
        ...
        <p><span className="twxt-red-500">5 days</span> left at this price!</p>
      </div>
